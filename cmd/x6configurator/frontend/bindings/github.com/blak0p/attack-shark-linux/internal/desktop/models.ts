...
export class ResetLaneResult {
    "Lane": string;
    "State": string;
    "Code": ErrorCode;

    /** Creates a new ResetLaneResult instance. */
    constructor($$source: Partial<ResetLaneResult> = {}) {
        if (!("Lane" in $$source)) {
            this["Lane"] = "";
        }
        if (!("State" in $$source)) {
    ...
    /**
     * Creates a new ResetLaneResult instance from a string or object.
     */
    static createFrom($$source: any = {}): ResetLaneResult {
        let $$parsedSource = typeof $$source === 'string' ? JSON.parse($$source) : $$source;
        return new ResetLaneResult($$parsedSource as Partial<ResetLaneResult>);
    }
}
...
export class ResetResult {
    ...
    constructor($$source: Partial<ResetResult> = {}) {
        ...
        if (!("Cleanup" in $$source)) {
            this["Cleanup"] = (new ResetLaneResult());
        }
        if (!("Error" in $$source)) {
            this["Error"] = (new Error());
        }
    ...
    static createFrom($$source: any = {}): ResetResult {
        ...
        if ("Cleanup" in $$parsedSource) {
            $$parsedSource["Cleanup"] = $$createField1_0($$parsedSource["Cleanup"]);
        }
        if ("Error" in $$parsedSource) {
            $$parsedSource["Error"] = $$createField2_0($$parsedSource["Error"]);
        }
